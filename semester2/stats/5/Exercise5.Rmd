...
$$
Var[T] = E[(T-E)^2] = E[T^2] - E[T] = \sum_{i=1}^{8} i^2\cdot \frac{1}{8} - E[T] = (\frac{1}{8} + \frac{4}{8} + \frac{9}{8} + \frac{16}{8} + \frac{25}{8} + \frac{36}{8} + \frac{49}{8} + \frac{64}{8}) - 4.5 = 25.5 - 4.5 = 21
$$
$$
...
function $f$ onb tge interval $0 \le x \le 1$.
